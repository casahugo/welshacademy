...
func TestIngredientList(t *testing.T) {
	...
	assert.Equal(
		t,
		`[{"id":1,"name":"mourtarde à l'ancienne","unit":"c.à.s"},{"id":2,"name":"poivre","unit":""},{"id":3,"name":"cheddar","unit":"g"},{"id":4,"name":"bière brune","unit":"cl"},{"id":5,"name":"pain de campagne non tranchée","unit":""},{"id":6,"name":"jambon blanc","unit":"tranche"},{"id":7,"name":"oeufs","unit":""}]`,
		w.Body.String(),
	)
}
